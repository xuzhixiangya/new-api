...
// RegisterScheduledSystemTasks wires periodic channel tests, upstream model
// updates, and async task polling into the system task framework so a DB lease
// dedups execution across multiple master instances.
